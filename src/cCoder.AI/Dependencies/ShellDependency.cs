...
internal sealed class ShellDependency : Process
{
...
environmentVariables: environmentVariables);
        ...
        Task<string> standardOutputTask = StandardOutput.ReadToEndAsync(cancellationToken: cancellationToken);
        Task<string> standardErrorTask = StandardError.ReadToEndAsync(cancellationToken: cancellationToken);

        await WaitForExitAsync(cancellationToken: cancellationToken);
